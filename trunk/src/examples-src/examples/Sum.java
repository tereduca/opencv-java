 ...
 * @date Jul 29, 2010
 */
public class Sum extends PApplet{
	...
	public void setup(){
		...
		im_diff = CxCore.createImage(w, h, PixelDepth.IPL_DEPTH_8U, ColorModel.BGR);
		im_last = CxCore.createImage(w, h, PixelDepth.IPL_DEPTH_8U, ColorModel.BGR);
	}
	...
	public void draw(){
		...
		if( HighGui.queryFrame(capture, im) ){
			...
			CxCore.absDiff(im, im_last, im_diff);
			Scalar sc = CxCore.sum(im_diff);
			System.out.println(sc);
			CxCore.copy(im, im_last);
		}
	}
}
